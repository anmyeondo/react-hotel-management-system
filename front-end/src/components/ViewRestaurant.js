        ...
        return (
            <Paper className={classes.paper}>
              <Grid container spacing={2} direction='column'>
                <Grid item >
                  <div className={classes.header} style={this.props.data.Available ? green : red }></div>
                </Grid >
                <Grid item xs={12} sm container>
                  <Grid item  container direction="column" spacing={2} className={classes.footer}>
                    <Grid item xs>
                      <img src="/image/basicImage" style={{width:"128px",height:"128px"}}/>
                      <Typography align='center' gutterBottom variant="subtitle1">
                        {this.props.data.Restaurant_Name}
                      </Typography>
                      <Typography align='center' variant="body2" gutterBottom >
                        {this.props.data.Open_Time.slice(undefined,5)} &nbsp;~&nbsp; {this.props.data.Close_Time.slice(undefined,5)}
                      </Typography>
                    </Grid>
